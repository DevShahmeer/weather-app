...
export const LOCAL_STORAGE_KEY_WELCOME_MODEL = 'welcomeModel';
...
export const ERROR_INVALID_LAT_LON = "Invalid latitude or longitude, make sure your browser supports JavaScript and HTML";
